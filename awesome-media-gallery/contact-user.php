...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <script>
        ...
        $(document).ready(function() {
			...
			var ModalContainer = '.contact-user-container';
			var ModalInnerContainer = '.modal-container';
			
			setNewHeight2(ModalContainer, ModalInnerContainer, '#ContactUserFrame');
  ...
  <body class="modal-body modal-contact-user">
	  <div class="modal-container">
	  <?php include ('includes/contact-user.php'); ?>
	  </div>  
  </body>
</html>