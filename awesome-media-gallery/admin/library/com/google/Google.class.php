...
class GoogleOAuth {
  ...
  public $host = "https://www-opensocial.googleusercontent.com/api/";
  /* Set timeout default. */
  public $timeout = 30;
  /* Set connect timeout. */
  ...
  public $http_info;
  /* Set the useragnet. */
  public $useragent = 'GoogleOAuth v0.2.0-beta2';
  /* Immediately retry the API call if the response was not successful. */
  //public $retry = TRUE;
  protected $scope = 'https://www-opensocial.googleusercontent.com/api/people/';
