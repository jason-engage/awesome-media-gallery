<?php
	require_once dirname(__FILE__).'/../../../../../../../../../library/com/mokoala/Mokoala.php';
	
	ini_set('display_errors', 0);

	require_once(MCMANAGER_ABSPATH . "FileManager/FileManagerPlugin.php");

	$application_absolute_path = realpath(dirname(__FILE__).'/../../../../../../../../../../').'/';
	...
	// Preview options
	$mcFileManagerConfig['preview.wwwroot'] = $application_absolute_path; // absolute or relative from this script path (c:/Inetpub/wwwroot).
	...
	$mcFileManagerConfig['filesystem.path'] = $application_absolute_path.'tpl/uploads/files/'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = $application_absolute_path.'tpl/uploads/files/'; // absolute or relative from this script path.
